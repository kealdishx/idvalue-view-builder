...
public class SimpleViewBuilder<B extends BuildContext> implements ViewBuilder<B> {
    private static final Logger logger = getLogger(SimpleViewBuilder.class);
    ...
    private void mergeToBuildContext(Map<Object, Map<Object, Object>> valuesMap, B buildContext) {
        for (Map.Entry<Object, Map<Object, Object>> entry : valuesMap.entrySet()) {
    ...
    private void valueBuild(Map<Object, Set<Object>> idsMap,
        ...
        for (Map.Entry<Object, Set<Object>> entry : idsMap.entrySet()) {
    ...
    private Map<Object, Object> filterValueMap(KeyPair<Map<Object, Object>> keyPair,
        ...
        for (Map.Entry<Object, Object> entry: keyPair.value.entrySet()) {
     ...
     */
    private <E> OnBuilder<E> on(Class<E> type) {
     ...
     */
    private <E> SimpleViewBuilder<B> self(Class<E> type, Function<E, Object> idExtractor) {
        SimpleViewBuilder<B>.OnBuilder<E> onBuilder = new OnBuilder<>(type);
     ...
     */
    private BuildingBuilder build(Object idNamespace) {
     ...
     * use {@link #buildValue} or {@link #buildValueTo}
     */
    private <K> SimpleViewBuilder<B> build(Object idNamespace,
    ...
    private SimpleViewBuilder<B> lazy(Lazy lazy) {
    ...
    public <E> SimpleViewBuilder<B> valueFromSelf(Class<E> type, Function<E, Object> idExtractor) {
        self(type, idExtractor);
        return this;
    }

    public <E> SimpleViewBuilder<B> extractId(Class<E> type, Function<E, Object> idExtractor,
                                              Object toIdNamespace) {
        on(type).id(idExtractor).to(toIdNamespace);
        return this;
    }

    public <E, V> SimpleViewBuilder<B> extractValue(Class<E> type,
    ...
    public <K> SimpleViewBuilder<B> buildValue(Object idNamespace,
                                               Function<Collection<K>, Map<K, ?>> valueBuilder) {
    ...
    public <K> SimpleViewBuilder<B> buildValueTo(Object idNamespace,
    ...
    public <K> SimpleViewBuilder<B> lazyBuild(Object sourceNamespace,
    ...
    private static final class KeyPair<V> implements Map.Entry<Object, V> {
    ...
    private final class OnBuilder<E> {
        ...
        public final class ExtractingValue {
            ...
            public SimpleViewBuilder<B> to(Object valueNamespace) {
        ...
        public final class ExtractingId {
            ...
            public SimpleViewBuilder<B> to(Object idNamespace) {
    ...
    private final class BuildingBuilder {
